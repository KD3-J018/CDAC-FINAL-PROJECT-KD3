...
//               <div className="card" style={{ width: "18rem" }}>
//                 <img src={sofaclean} className="card-img-top" alt="Sofa Cleaning" />
//                 <div className="card-body">
//                   <p className="card-text">Sofa Cleaning</p>
//                   <FaStar />
//                   <FaStar />
...
//               <div className="card" style={{ width: "18rem" }}>
//                 <img src={bathclean} className="card-img-top" alt="Bathroom Cleaning" />
//                 <div className="card-body">
//                   <p className="card-text">Bathroom Cleaning</p>
//                   <FaStar />
//                   <FaStar />
...
//               <div className="card" style={{ width: "18rem" }}>
//                 <img src={geyser} className="card-img-top" alt="Geyser Service" />
//                 <div className="card-body">
//                   <p className="card-text">Geyser Service</p>
//                   <FaStar />
//                   <FaStar />
...
//               <div className="card" style={{ width: "18rem" }}>
//                 <img src={instence} className="card-img-top" alt="Intense Cleaning" />
//                 <div className="card-body">
//                   <p className="card-text">Intense Cleaning</p>
//                   <FaStar />
//                   <FaStar />
...
//               <div className="card" style={{ width: "18rem" }}>
//                 <img src={doorlock} className="card-img-top" alt="Door Lock Repair" />
//                 <div className="card-body">
//                   <p className="card-text">Door Lock Repair</p>
//                   <FaStar />
//                   <FaStar />
...
//     if (searchTerm.trim() === "") {
//       setFilteredServices(services); // Show all services if the search term is empty
//     } else {
...
//               key={service.id}
//               className="col"
//               onClick={() => console.log(`Selected service: ${service.id}`)}
//             >
//               <div className="card" style={{ width: "18rem" }}>
//                 <img
//                   src={service.img}
