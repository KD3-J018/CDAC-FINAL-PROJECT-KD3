...
//   const { service } = useParams();    //added for showing the taskers for particular service selected in footer under our services
...
//     tasker.category.toLowerCase().includes(service.toLowerCase()) // Ensure the category matches the service param
//   ); //footer filter
...
//   const filteredTaskers = taskers.filter(tasker =>
//     tasker.category.toLowerCase().replace(/\s+/g, "").includes(service.toLowerCase().replace(/\s+/g, ""))
//   );
...
//   const taskers = [
//     { id: 1, name: "John Doe", category: "Door Lock Repairing", location: "New York, NY", hourlyRate: "150/hr", rating: 4.8 },
//     { id: 2, name: "Jane Smith", category: "Geyser Service", location: "Los Angeles, CA", hourlyRate: "200/hr", rating: 4.5 },
//     { id: 3, name: "Tom Brown", category: "Bathroom Cleaning", location: "Chicago, IL", hourlyRate: "599/hr", rating: 4.6 },
//     { id: 4, name: "Lucy Green", category: "Sofa Cleaning", location: "Houston, TX", hourlyRate: "399/hr", rating: 4.7 },
//     { id: 5, name: "Mike Johnson", category: "Intense Cleaning", location: "Phoenix, AZ", hourlyRate: "299/hr", rating: 4.4 },
//     { id: 6, name: "Sophia Lee", category: "Men Haircutting", location: "Philadelphia, PA", hourlyRate: "999/hr", rating: 4.9 },
//     { id: 7, name: "Chris Wilson", category: "Sofa Cleaning", location: "San Antonio, TX", hourlyRate: "899/hr", rating: 4.6 },
//     { id: 8, name: "Emily Davis", category: "Intense Cleaning", location: "San Diego, CA", hourlyRate: "299/hr", rating: 4.8 },
//     { id: 9, name: "Daniel Moore", category: "Door Lock Repairing", location: "Dallas, TX", hourlyRate: "399/hr", rating: 4.3 },
//     { id: 10, name: "Olivia Martinez", category: "Geyser Service", location: "San Jose, CA", hourlyRate: "199/hr", rating: 5.0 },
//     { id: 11, name: "Daniel Moore", category: "Bathroom Cleaning", location: "Dallas, TX", hourlyRate: "399/hr", rating: 4.3 },
//     { id: 12, name: "Olivia Martinez", category: "Sofa Cleaning", location: "San Jose, CA", hourlyRate: "199/hr", rating: 5.0 },
//   ];
